...
class ControllableEntity:
    def __init__(self, token, position, abilities, resources, size,
                 role_name, battery, battery_by_movement, speed, physical_capacity, virtual_capacity, **kwargs):
        self.type = 'controllable_entity'
        self.is_active = True
